(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('date-fns/format'), require('date-fns/sub_months'), require('date-fns/add_months'), require('date-fns/get_days_in_month'), require('date-fns/last_day_of_month'), require('date-fns/get_month'), require('date-fns/set_month'), require('date-fns/get_year'), require('date-fns/set_year'), require('date-fns/is_same_month'), require('date-fns/is_same_day'), require('date-fns/add_days'), require('date-fns/sub_days'), require('date-fns/add_weeks'), require('date-fns/sub_weeks'), require('date-fns/start_of_week'), require('date-fns/end_of_week'), require('date-fns/is_before'), require('date-fns/is_after'), require('date-fns/is_valid')) :
  typeof define === 'function' && define.amd ? define(['date-fns/format', 'date-fns/sub_months', 'date-fns/add_months', 'date-fns/get_days_in_month', 'date-fns/last_day_of_month', 'date-fns/get_month', 'date-fns/set_month', 'date-fns/get_year', 'date-fns/set_year', 'date-fns/is_same_month', 'date-fns/is_same_day', 'date-fns/add_days', 'date-fns/sub_days', 'date-fns/add_weeks', 'date-fns/sub_weeks', 'date-fns/start_of_week', 'date-fns/end_of_week', 'date-fns/is_before', 'date-fns/is_after', 'date-fns/is_valid'], factory) :
...
}(this, (function (format,subMonths,addMonths,getDaysInMonth,lastDayOfMonth,getMonth,setMonth,getYear,setYear,isSameMonth,isSameDay,addDays,subDays,addWeeks,subWeeks,startOfWeek,endOfWeek,isBefore,isAfter,isValid) { 'use strict';
  ...
  return _c('td',{key:index + '_' + dayNumber,ref:("date-" + fullDate),refInFor:true,staticClass:"asd__day",class:{ 'asd__day--enabled': dayNumber !== 0, 'asd__day--empty': dayNumber === 0, 'asd__day--disabled': _vm.isDisabled(fullDate), 'asd__day--selected': fullDate && (_vm.selectedDate1 === fullDate || _vm.selectedDate2 === fullDate), 'asd__day--in-range': _vm.isInRange(fullDate), 'asd__day--not-in-month': notInMonth, 'asd__day--today': fullDate && _vm.isToday(fullDate), 'asd__selected-date-one': fullDate && fullDate === _vm.selectedDate1, 'asd__selected-date-two': fullDate && fullDate === _vm.selectedDate2, },style:(_vm.getDayStyles(fullDate)),attrs:{"data-date":fullDate,"tabindex":_vm.isDateVisible(fullDate) && _vm.isSameDate(_vm.focusedDate, fullDate) ? 0 : -1,"aria-label":_vm.isDateVisible(fullDate) ? _vm.getAriaLabelForDate(fullDate) : false},on:{"mouseover":function () { _vm.setHoverDate(fullDate); }}},[(dayNumber)?_c('button',{staticClass:"asd__day-button",attrs:{"type":"button","tabindex":"-1","date":fullDate,"disabled":_vm.isDisabled(fullDate)},on:{"click":function () { _vm.selectDate(fullDate); }}},[_vm._v(_vm._s(dayNumber))]):_vm._e()])}))}))])])})),_vm._v(" "),(_vm.showShortcutsMenuTrigger)?_c('div',{class:{ 'asd__keyboard-shortcuts-menu': true, 'asd__keyboard-shortcuts-show': _vm.showKeyboardShortcutsMenu},style:(_vm.keyboardShortcutsMenuStyles)},[_c('div',{staticClass:"asd__keyboard-shortcuts-title"},[_vm._v(_vm._s(_vm.texts.keyboardShortcuts))]),_vm._v(" "),_c('button',{ref:"keyboard-shortcus-menu-close",staticClass:"asd__keyboard-shortcuts-close",attrs:{"tabindex":"0","aria-label":_vm.ariaLabels.closeKeyboardShortcutsMenu},on:{"click":_vm.closeKeyboardShortcutsMenu}},[(_vm.$slots['close-shortcuts-icon'])?_vm._t("close-shortcuts-icon"):_c('div',{staticClass:"asd__mobile-close-icon",attrs:{"aria-hidden":"true"}},[_vm._v("X")])],2),_vm._v(" "),_c('ul',{staticClass:"asd__keyboard-shortcuts-list"},_vm._l((_vm.keyboardShortcuts),function(shortcut,i){return _c('li',{key:i},[_c('span',{staticClass:"asd__keyboard-shortcuts-symbol",attrs:{"aria-label":shortcut.symbolDescription}},[_vm._v(_vm._s(shortcut.symbol))]),_vm._v(" "+_vm._s(shortcut.label)+" ")])}))]):_vm._e()],1),_vm._v(" "),(_vm.mode !== 'single' && _vm.showActionButtons)?_c('div',{staticClass:"asd__action-buttons"},[_c('button',{attrs:{"type":"button"},on:{"click":_vm.closeDatepickerCancel}},[_vm._v(" "+_vm._s(_vm.texts.cancel)+" ")]),_vm._v(" "),_c('button',{ref:"apply-button",style:({color: _vm.colors.selected}),attrs:{"type":"button"},on:{"click":_vm.apply}},[_vm._v(" "+_vm._s(_vm.texts.apply)+" ")])]):_vm._e(),_vm._v(" "),(_vm.showShortcutsMenuTrigger)?_c('div',{staticClass:"asd__keyboard-shortcuts-trigger-wrapper"},[_c('button',{staticClass:"asd__keyboard-shortcuts-trigger",attrs:{"aria-label":_vm.ariaLabels.openKeyboardShortcutsMenu,"tabindex":"0"},on:{"click":_vm.openKeyboardShortcutsMenu}},[_c('span',[_vm._v("?")])])]):_vm._e()])])},staticRenderFns: [],
    ...
    methods: {
      ...
      getWeeks: function getWeeks(date) {
        ...
        for (var s = firstDayInWeek - 1; s > 0; s--) {
          if (this$1.showNotInMonthDays) {
            var notInMonthDate = subDays(date, s);
            var dayNumber = format(notInMonthDate, 'D');
            var dayNumberFull = format(notInMonthDate, 'DD');
        ...
        for (var d = 0; d < daysInMonth; d++) {
          ...
          var dayNumber$1 = d + 1;
          var dayNumberFull$1 = dayNumber$1 < 10 ? '0' + dayNumber$1 : dayNumber$1;
          week.push({
            dayNumber: dayNumber$1,
            dayNumberFull: dayNumberFull$1,
            fullDate: year + '-' + month + '-' + dayNumberFull$1,
          });
          ...
          if (week.length === 7) {
            ...
            var currentDate = new Date(year, month - 1, dayNumber$1);
            var weekLength = week.length;

            for (var i = 0; i < 7 - weekLength; i++) {
              if (this$1.showNotInMonthDays) {
                var notInMonthDate$1 = addDays(currentDate, i + 1);
                var dayNumber$2 = format(notInMonthDate$1, 'D');
                var dayNumberFull$2 = format(notInMonthDate$1, 'DD');

                week.push({
                  dayNumber: dayNumber$2,
                  dayNumberFull: dayNumberFull$2,
                  fullDate: format(notInMonthDate$1, 'YYYY-MM-DD'),
                  notInMonth: true,
                });
              } else {
                week.push(weekDayNotInMonth);
